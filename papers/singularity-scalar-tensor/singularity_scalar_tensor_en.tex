...
\noindent 1. **The Zurvan Field Energy-Momentum Tensor:**
\begin{equation}
\Tzurvan = \partial_\mu \phiZ \partial_\nu \phiZ - g_{\mu\nu} \mathcal{L}_Z
\end{equation}

\noindent 2. **The Effective Matter Energy-Momentum Tensor:**
\begin{equation}
\Teff = (1 + \Aphi) \Tmat
\end{equation}
...
\end{equation}
This crucial equation shows that the matter Lagrangian $\Lmat$ (which is approximately $-\rho_m$ for non-relativistic matter) acts as a **source** for the Zurvan field $\phiZ$.
...
\noindent 1. **Low-Density Regime (Normal Spacetime):**
...
\noindent 2. **High-Density Regime (Singularity Formation):**
...
\noindent 3. **The Final State (The $r=0$ Core):**
